...
class Process {
    ...
    function procRegister() {
        ...
        $retval = $session->register($_POST['user'], $_POST['pass'], $_POST['email'], $_POST['vardas'], $_POST['pavarde'], $_POST['tel']);
    ...
    function procEditAccount() {
        ...
        $retval = $session->editAccount($_POST['curpass'], $_POST['newpass'], $_POST['email'], $_POST['vardas'], $_POST['pavarde'], $_POST['tel']);
